<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΑΝΔΡΑΣ' AND onoma_upokathgorias='ΣΩΜΑ'";
	...
	echo "<html>
				...
				<body>
					...
					Εμφάνιση: <a href='adras_soma.php?limit=3'>3</a> <a href='adras_soma.php?limit=6'>6</a> <a href='adras_soma.php'>All</a>
