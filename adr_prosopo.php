<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΑΝΔΡΑΣ' AND onoma_upokathgorias='ΠΡΟΣΩΠΟ'";
	...
	echo "<html>
				...
				<body>
					...
					Εμφάνιση: <a href='adr_prosopo.php?limit=3'>3</a> <a href='adr_prosopo.php?limit=6'>6</a> <a href='adr_prosopo.php'>All</a>
