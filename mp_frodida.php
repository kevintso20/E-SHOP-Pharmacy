<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΜΗΤΕΡΑ&ΠΑΙΔΙ' AND onoma_upokathgorias='ΦΡΟΝΤΙΔΑ ΜΩΡΟΥ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΦΡΟΝΤΙΔΑ ΜΩΡΟΥ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='mp_frodida.php?limit=3'>3</a> <a href='mp_frodida.php?limit=6'>6</a> <a href='mp_frodida.php'>All</a>
