<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΦΑΡΜΑΚΕΙΟ' AND onoma_upokathgorias='ΣΤΟΜΑΤΙΚΗ ΥΓΙΕΙΝΗ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΣΤΟΜΑΤΙΚΗ ΥΓΙΕΙΝΗ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='farm_stoma.php?limit=3'>3</a> <a href='farm_stoma.php?limit=6'>6</a> <a href='farm_stoma.php'>All</a>
