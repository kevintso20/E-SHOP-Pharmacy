<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='4 ΕΠΟΧΕΣ' AND onoma_upokathgorias='ΧΕΙΜΩΝΑΣ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΧΕΙΜΩΝΑΣ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='4epox_xeim.php?limit=3'>3</a> <a href='4epox_xeim.php?limit=6'>6</a> <a href='4epox_xeim.php'>All</a>
	...
	while($users_row=mysql_fetch_array($users_all)) {
		...
		echo"			<td class=\"proion\" valign='bottom' >
