<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΓΥΝΑΙΚΑ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΓΥΝΑΙΚΑ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='gunaika.php?limit=3'>3</a> <a href='gunaika.php?limit=6'>6</a> <a href='gunaika.php'>All</a>
