<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΦΑΡΜΑΚΕΙΟ' AND onoma_upokathgorias='ΥΓΕΙΑ ΚΑΤΩ ΑΚΡΩΝ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΥΓΕΙΑ ΚΑΤΩ ΑΚΡΩΝ</h2><br/><br/>
					</div>
