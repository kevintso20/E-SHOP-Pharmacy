...
echo"<meta charset='utf-8' />";
	...
	$query="select * from orders WHERE katastash=1";
	...
	echo "<html>
				...
				<body>
					...
					<br/><br/>
					<h2 id='faceh2'>ΔΙΑΒΑΣΤΗΚΑΝ</h2><br/><br/>
					<div class='parag'>
		...
		while($user_row=mysql_fetch_array($users_all)) {
			...
			echo"
				<tr>
				<td>
				<form action='aponaiseolokl.php' method='POST'>
				<button  class='s' type='submit'> Ολοκληρώθηκε</button>
				<input type='hidden' value=".$user_row["id"]." name='id_paraggelias'>
				<input type='hidden' value=".$user_row["id_proiontos"]." name='id_proiontos'>
				<input type='hidden' value=".$user_row["posothta"]." name='posothta'>
				</form>";
				echo"
				</td>
				</tr>
