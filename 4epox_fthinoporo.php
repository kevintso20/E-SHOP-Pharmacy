<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='4 ΕΠΟΧΕΣ' AND onoma_upokathgorias='ΦΘΙΝΟΠΩΡΟ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΦΘΙΝΟΠΩΡΟ</h2><br/><br/>
					</div>
