<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΑΝΔΡΑΣ' AND onoma_upokathgorias='ΞΥΡΙΣΜΑ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΞΥΡΙΣΜΑ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='ksirisma.php?limit=3'>3</a> <a href='ksirisma.php?limit=6'>6</a> <a href='ksirisma.php'>All</a>
