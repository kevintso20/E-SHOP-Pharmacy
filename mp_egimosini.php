<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='ΜΗΤΕΡΑ&ΠΑΙΔΙ' AND onoma_upokathgorias='ΕΓΚΥΜΟΣΥΝΗ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΕΓΚΥΜΟΣΥΝΗ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='mp_egimosini.php?limit=3'>3</a> <a href='mp_egimosini.php?limit=6'>6</a> <a href='mp_egimosini.php'>All</a>
