<?php
	...
	$query="select * from proionta,kathgories where proionta.id=kathgories.id_proiontos AND onoma_kathgorias='4 ΕΠΟΧΕΣ' AND onoma_upokathgorias='ΑΝΟΙΞΗ'";
	...
	echo "<html>
				...
				<div class='start'>
					...
					<h2 id='faceh2'>ΑΝΟΙΞΗ</h2><br/><br/>
					</div>
					<p>Βρέθηκαν $num προιόντα</p>
					Εμφάνιση: <a href='4epox_anoiksh.php?limit=3'>3</a> <a href='4epox_anoiksh.php?limit=6'>6</a> <a href='4epox_anoiksh.php'>All</a>
